...
export function GuardedForm({onSubmit,children,...props}:Omit<ComponentProps<'form'>,'onSubmit'> & {onSubmit?:(e:FormEvent<HTMLFormElement>)=>unknown;children:ReactNode}){

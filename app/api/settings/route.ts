...
export async function POST(req:Request){try{
 ...
 const b=z.object({notification_sound:z.enum(Object.keys(soundPresets) as [string,...string[]])}).parse(JSON.parse(raw));
 await setSetting('notification_sound',b.notification_sound);

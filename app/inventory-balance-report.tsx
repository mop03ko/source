...
export default function InventoryBalanceReport({summary,categories,from,to,warehouse,view,onView,onStock,onCategory}:{summary:Record<string,number>;categories:BalanceCategory[];from:string;to:string;warehouse:string;view:BalanceView;onView:(view:BalanceView)=>void;onStock:(stock:string)=>void;onCategory:(category:string)=>void}){
 ...
 return <div className="balance-report">
  ...
  <details className="balance-method"><summary>Тайланг хэрхэн унших вэ?</summary><p>Өртөг нь худалдах үнэ, борлуулалтын орлого биш. Ангилал, брэнд, нийлүүлэгчийг барааны одоогийн бүртгэлээр харуулна.</p><p className="balance-equation">Тоо ширхэг: эхний үлдэгдэл + орлого − зарлага = эцсийн үлдэгдэл. Орлого, зарлагад шилжүүлэг, буцаалт, тооллогын тохируулга багтана.{adjustment!==0&&` Өртгийн дүнд нэмэгдэх, тоо өөрчлөхгүй тохируулга: ${number(adjustment/100)} ₮.`}</p></details>
